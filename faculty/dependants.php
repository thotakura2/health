...
<html lang="en">
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="dependants.php">
            <i class="fab fa-accessible-icon"></i>
            <span>Dependants</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="medication.php">
            <i class="fas fa fa-user-md"></i>
            <span>Previous Medication</span></a>
        </li>
      </ul>
  ...
  $raw_results = mysqli_query($db,"SELECT * FROM `dependant` WHERE dependant_on='$reg'") or die(mysql_error()); 
  ?>
  <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    ...
    if (mysqli_num_rows($raw_results) < 1) {
      ?>
      <tr>
        <td colspan="4" style="text-align: center;">NO Daependants</td>
      </tr>
      <?php
    }
    ...
    ?>
    <tr class="noBorder">
      <td colspan="3" style="text-align: center;"><a href="add_dependant.php"> Add a Dependant</a></td>
    </tr>
   </tbody>
                </table>
              </div>
