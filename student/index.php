...
<html lang="en">
  ...
  <body class="bg-dark">
    <center><h2 style="color: white;padding-top: 50px;">Faculty Portal</h2></center>
		<form id='login' action='<?php echo $fgmembersite->GetSelfScript(); ?>' method="post" accept-charset='UTF-8' class="login-form"> 
      ...
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          ...
          <div class="text-center">
            ...
            <blink><?php
            error_reporting(0);
           echo $fgmembersite->GetErrorMessage(); ?></blink>
          </div>
        </div>
      </div>
    </div>
