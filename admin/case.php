          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0" action="case.php" method="GET">
        <div class="input-group">
            <p></p>
    ...
    ?>
            ...
            // $results = mysql_fetch_array($raw_results) puts data from database into array, while it's valid it does the loop
             ...
             <tr>
              ...
              <td style="width: 10%"><button class="btn btn-primary" onclick="location.href = 'medication.php?regno=<?php echo $results['username'] ?>&tab=users';">Select</button></td>
             </tr>
    ...
    ?>
            ...
            // $results = mysql_fetch_array($raw_results) puts data from database into array, while it's valid it does the loop
             ...
             <tr>
              <td><?php echo $results['username']; ?></td>
              <td><?php echo $results['name']; ?></td>
              <td style="width: 10%"><button class="btn btn-primary" onclick="location.href = 'medication.php?regno=<?php echo $results['username'] ?>&tab=faculty';">Select</button></td>
             </tr>
    ...
    ?>
            ...
            // $results = mysql_fetch_array($raw_results) puts data from database into array, while it's valid it does the loop
             ...
             <tr>
              <td><?php echo $results['username']; ?></td>
              <td><?php echo $results['name']; ?></td>
              <td style="width: 10%"><button class="btn btn-primary" onclick="location.href = 'medication.php?regno=<?php echo $results['username'] ?>&tab=dependant';">Select</button></td>
             </tr>
